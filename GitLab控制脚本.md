...
**命令**：`mapping add <full-path> <short-name>`
...
**命令**：`branch create [--repo <repo>] <branch-name> <base-branch> [--list | --all]`
...
**命令**：`branch protect [--repo <repo>] <branch-name> [--access-level <level>] [--list | --all]`
...
- `--repo`：仓库标识（完整路径或简称）
- `branch-name`：分支名称
- `--access-level`：访问级别（noone、maintainers、developers），默认noone
- `--list`：使用映射文件中的所有仓库
- `--all`：使用所有可访问仓库
...
**命令**：`branch unprotect [--repo <repo>] <branch-name> [--list | --all]`
...
**命令**：`tag create [--repo <repo>] <tag-name> <ref> [--list | --all]`
...
**命令**：`tag protect [--repo <repo>] <tag-pattern> [--access-level <level>] [--list | --all]`
...
**命令**：`tag unprotect [--repo <repo>] <tag-pattern> [--list | --all]`
...
**命令**：`merge-request create [--repo <repo>] <source-branch> <target-branch> <title> [--list | --all]`
...
**命令**：`merge-request approve [--repo <repo>] (<mr-iid> | <source-branch> <target-branch>) [--list | --all]`
...
**命令**：`merge-request merge [--repo <repo>] (<mr-iid> | <source-branch> <target-branch>) [--list | --all]`
...
**命令**：`merge-request close [--repo <repo>] (<mr-iid> | <source-branch> <target-branch>) [--list | --all]`
...
**命令**：`merge-request approve-and-merge [--repo <repo>] (<mr-iid> | <source-branch> <target-branch>) [--list | --all]`
